      ...
      <div id='main'>
        <div className='homepage'>
          ...
          <div className='introduction'>
            ...
            {/* <p id='_intro1'>
              Đây là 1 phần mềm tiện ích giúp quản lý sinh viên một cách
            ...
            <div className='footer1'>
              ...
              <p id='_footer2'>
                ...
                động hành chính và học tập của họ.Chúng tôi cung cấp một giải
            ...
            <div className='footer2'>
              <hr className='elements' id='homehr' />
              <h1 id='_footer1'>Các tính năng </h1>
